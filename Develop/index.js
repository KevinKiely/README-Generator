// Imported dependencies and functions
...
function init() {
    ...
    .then((responses) => {
        ...
        fs.writeFile('./finalProduct/README.md', generateMarkdown(responses) , (err) =>
        err ? console.error(err) : console.log('File Created Successfully')
        );

        fs.appendFile('./finalProduct/README.md', generateMarkdown(responses), (err) => err ? console.error(err) : console.log('Answers Appended to File')
        );
